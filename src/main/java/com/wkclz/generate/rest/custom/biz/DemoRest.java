...
public class DemoRest {
     ...
     *
     */
    @GetMapping(Routes.DEMO_TYPES_PAGE)
     ...
     *
     */
    @GetMapping(Routes.DEMO_TYPES_COUNT)
     ...
     *
     */
    @GetMapping(Routes.DEMO_TYPES_DETAIL)
     ...
     *
     */
    @PostMapping(Routes.DEMO_TYPES_NEW)
     ...
     *
     */
    @PostMapping(Routes.DEMO_TYPES_UPDATE)
    @Transactional(rollbackFor = Exception.class)
     ...
     *
     */
    @PostMapping(Routes.DEMO_TYPES_SAVE)
    @Transactional(rollbackFor = Exception.class)
     ...
     *
     */
    @PostMapping(Routes.DEMO_TYPES_REMOVE)
    @Transactional(rollbackFor = Exception.class)
